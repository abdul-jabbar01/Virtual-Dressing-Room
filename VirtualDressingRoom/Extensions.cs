...
namespace VirtualDressingRoom
{
    public static class Extensions
    {
        ...
        public static List<ColorSpacePoint> DrawSkeleton(this Canvas canvas, Body body)
        {
            if (body == null) return null;

            List<ColorSpacePoint> points = new List<ColorSpacePoint>();
            foreach (Joint joint in body.Joints.Values)
            {
                ColorSpacePoint abc = tryClothes._sensor.CoordinateMapper.MapCameraPointToColorSpace(joint.Position);
                points.Add(abc);
                //canvas.DrawPoint(joint, ++x, points);
            }
            return points;
        }
        ...
        public static ImageSource bitmapToImageSource(Bitmap yourBitmap)
        {
        ...
        public static System.Windows.Point Scale(this Joint joint, CoordinateMapper mapper)
        {
        ...
        public static void DrawPoint(this Canvas canvas, Joint joint, CoordinateMapper mapper)
        {
            ...
            System.Windows.Point point = joint.Scale(mapper);
        ...
        public static void DrawHand(this Canvas canvas, Joint hand, CoordinateMapper mapper)
        {
            ...
            System.Windows.Point point = hand.Scale(mapper);
        ...
        public static void DrawThumb(this Canvas canvas, Joint thumb, CoordinateMapper mapper)
        {
            ...
            System.Windows.Point point = thumb.Scale(mapper);
        ...
        public static void DrawLine(this Canvas canvas, Joint first, Joint second, CoordinateMapper mapper)
        {
            ...
            System.Windows.Point firstPoint = first.Scale(mapper);
            System.Windows.Point secondPoint = second.Scale(mapper);
